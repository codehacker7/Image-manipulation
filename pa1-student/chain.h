...
public:
	...
	PNG Render(unsigned int cols);	// Renders Chain's pixel data to an output image - TO BE IMPLEMENTED
	...
	void RotateCCW(unsigned int cols);		// Rearranges the Node structure and internal pixel data to be rotated counter-clockwise - TO BE IMPLEMENTED
